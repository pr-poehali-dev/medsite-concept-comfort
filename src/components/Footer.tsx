      ...
      <div className="container py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          <div>
            ...
            <p className="mb-4">
              Мы заботимся о вашем здоровье и комфорте. Наша миссия - обеспечить высококачественную медицинскую помощь с использованием современных технологий.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <span>ул. Медицинская, 123, г. Москва, 123456</span>
              </li>
              <li className="flex items-start gap-2">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/doctors" className="hover:underline">Врачи</Link>
              </li>
              <li>
                <Link to="/prices" className="hover:underline">Цены</Link>
              </li>
              <li>
